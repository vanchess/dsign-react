import { MESSAGE_OUT_CHANGE_PER_PAGE, MESSAGE_OUT_CHANGE_PAGE } from '../../../constants/billPaginationConstants'
import { messageFetch } from '../../bill/messageOutAction.js'
...
export const messageStartChangeRowPerPage = (newPerPage) => {
    return (dispatch, getState) => {
        ...
        let currentPerPage = state.paginationReducer.bill.outgoing.perPage;
...
export const messageStartChangePage = (newPage) => {
    return (dispatch, getState) => {
        ...
        const state = getState();
        let currentPage = state.paginationReducer.bill.outgoing.page;
