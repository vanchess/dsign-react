...
import { MESSAGE_OUT_GET_REQUEST, MESSAGE_OUT_GET_SUCCESS, MESSAGE_OUT_GET_FAILURE } from '../../constants/messageConstants.js'
...
export const messageFetch = (page, perPage) => {
  return (dispatch) => {
    ...
    messageService.getAll(page, perPage).then(
