...
import { messageFetch } from '../../store/expertise/messageOutAction.js'
import { messageStartChangeRowPerPage, messageStartChangePage } from '../../store/pagination/expertise/messageOutPaginationAction.js'
...
class MekOutMessage extends React.Component {
    ...
    handleClickShowItem(id){
        this.props.history.push(`/expertise/msg/${id}`)
    }
...
const mapStateToProps = function(store) {
  ...
  return {
      ...
      perPage: store.paginationReducer.expertise.outgoing.perPage,
      itemsTotal: store.paginationReducer.expertise.outgoing.itemsTotal,
      loading: store.expertiseReducer.outgoing.loading,
    };
}
...
export default connect(mapStateToProps,mapDispatchToProps)(withRouter(withStyles(styles)(MekOutMessage)));