...
import SmoFinFilter from './SmoFinFilter.js';
import SmoFinList from './SmoFinList.js';
import SmoFinShowMessage from './SmoFinShowMessage.js';

export default function SmoFinIn(props) {
  ...
  return (
    <div>
      ...
      <FullScreenDialog title={msgTitle} open={openMessageDialog} onClose={handleCloseDialog}>
          <SmoFinShowMessage setTitle={props.setTitle}/>
      </FullScreenDialog>
    </div>
  );
}