...
import { messageFetch } from '../../store/bill/rejectedOutAction.js'
import { messageStartChangeRowPerPage, messageStartChangePage } from '../../store/pagination/bill/rejectedOutPaginationAction.js'
...
const mapStateToProps = function(store) {
  // console.log(store);
  return {
      items: store.billReducer.rejectedOut.items, 
      page: store.paginationReducer.bill.rejectedOut.page, 
      perPage: store.paginationReducer.bill.rejectedOut.perPage,
      itemsTotal: store.paginationReducer.bill.rejectedOut.itemsTotal,
      loading: store.billReducer.rejectedOut.loading,
    };
}
...
export default connect(mapStateToProps,mapDispatchToProps)(withRouter(withStyles(styles)(BillsInRejected)));