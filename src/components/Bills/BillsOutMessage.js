...
import { messageFetch } from '../../store/bill/messageOutAction.js'
import { messageStartChangeRowPerPage, messageStartChangePage } from '../../store/pagination/bill/messageOutPaginationAction.js'
...
class BillsOutMessage extends React.Component {
...
const mapStateToProps = function(store) {
  // console.log(store);
  return {
      items: store.billReducer.outgoing.items, 
      page: store.paginationReducer.bill.outgoing.page, 
      perPage: store.paginationReducer.bill.outgoing.perPage,
      itemsTotal: store.paginationReducer.bill.outgoing.itemsTotal,
      loading: store.billReducer.outgoing.loading,
    };
}
...
export default connect(mapStateToProps,mapDispatchToProps)(withRouter(withStyles(styles)(BillsOutMessage)));