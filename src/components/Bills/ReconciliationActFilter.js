...
function ReconciliationActFilter(props) {
        ...
        >
          ...
          <DivColumn>
            <Typography sx={{fontSize: theme => theme.typography.pxToRem(15), color: theme => theme.palette.text.secondary,}}>
                Укажите параметры и нажмите кнопку &laquo;Загрузить&raquo;
            </Typography>
          </DivColumn>
          <DivColumn>
...
export default connect(mapStateToProps,mapDispatchToProps)(ReconciliationActFilter);