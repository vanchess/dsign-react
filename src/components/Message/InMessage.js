...
const mapStateToProps = function(store) {
  ...
  return {
      ...
      perPage: store.paginationReducer.message.incoming.perPage,
      itemsTotal: store.paginationReducer.message.incoming.itemsTotal,
      loading: store.messageReducer.incoming.loading,
    };
}
