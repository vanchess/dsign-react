          ...
          if (this.props.permission.includes('monitor reg')) {
                    return (
                      <div className={classes.root}>
                          <CssBaseline />
                          <Header title={'Мониторинг. 2 этап (исправленные реестры)'} open={false} userName={''} handleDrawerOpen={() => {}} logout={authService.logout} />
                          <main className={classes.content}>
                              <div className={classes.appBarSpacer} />
                              
                                      <div className={classes.content}>
                                          <iframe src="http://192.168.12.18:4567/stage2" width="100%" height="100%">
